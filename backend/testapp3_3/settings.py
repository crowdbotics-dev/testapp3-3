"""
Django settings for testapp3_3 project.
...
WSGI_APPLICATION = 'testapp3_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testapp3_3 API",
    "DESCRIPTION": "API documentation for testapp3_3 App",
    "VERSION": "v1",
}
